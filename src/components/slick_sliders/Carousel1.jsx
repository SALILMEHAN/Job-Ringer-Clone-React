      ...
      <section className="w-full h-64 overflow-hidden relative">
        ...
        >
          {slides.map((job) => (
            <div
              key={job.id}
              className=" bg-white p-4 rounded-md shadow-md  shadow-gray-800 text-sm text-left m-2 relative pt-10 pr-10"
            >
              <div className="flex justify-between text-sm items-center mb-2">
                ...
                <span className="bg-yellow-400 text-black font-semibold px-2 py-1 absolute top-0 right-0 rounded-bl-3xl">
                  {job.type}
                </span>
              </div>
              ...
              <button className="bg-skyBlue text-white px-4 py-2 rounded box-content font-semibold w-full">
                {job.apply}
              </button>
            </div>
          ))}
