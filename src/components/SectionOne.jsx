    ...
    <>
      <main className="container mx-auto py-3 px-5">
        ...
        <div className="flex flex-col md:flex-row justify-evenly align-middle gap-7">
          ...
          <div className="bg-skyBlue p-2 pt-3 rounded-md w-full md:w-1/2 flex flex-col justify-center items-center">
            <h2 className="text-blue-900 text-lg font-bold mb-2 flex gap-2">
              Quick Job Search <FaSearch className="mt-1" />
            </h2>
